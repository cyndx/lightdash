...
| `SITE_PRIVACY_POLICY_URL`                    | Site privacy policy url to be linked in the footer of the Lightdash UI as well as in e-mails.                                                                                                                 |           | `https://lightdash.com/privacy-policy`                          |
| `SITE_SLACK_COMMUNITY_URL`                   | Site slack community url to be linked in the footer of the Lightdash UI as well as in e-mails.                                                                                                                |           | `https://lightdash-community.slack.com/ssb/redirect`            |
...
| `AUTH_DISABLE_REGISTRATION`            | If `"true"` disables registration of new users via the signup modal              |           | false   |
